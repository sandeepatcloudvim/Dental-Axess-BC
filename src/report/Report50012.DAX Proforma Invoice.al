report 50012 "DAX Proforma Invoice"
{
    // version NAVW17.10.00.36281,NAVAPAC7.10.00.36281,EC1.01
    ...
    DefaultLayout = RDLC;
    RDLCLayout = './DAX Proforma Invoice.rdl';

    CaptionML = ENU = 'Order Confirmation',
                ENA = 'Order Confirmation';
    ...
    var
        ...
        Text004: TextConst ENU = 'Order Confirmation%1', ENA = 'Order Confirmation%1';
        ...
        ShipmentDateCaptionLbl: TextConst ENU = 'Shipment Date', ENA = 'Shipment Date';
        OrderNoCaptionLbl: TextConst ENU = 'Order No.', ENA = 'Order No.';
        ABNCaptionLbl: TextConst ENU = 'ABN', ENA = 'ABN';
        ABNDivPartNoCaptionLbl: TextConst ENU = 'Div. Part No.', ENA = 'Div. Part No.';
        PaymentTermsCaptionLbl: TextConst ENU = 'Payment Terms', ENA = 'Payment Terms';
        ShipmentMethodCaptionLbl: TextConst ENU = 'Shipment Method', ENA = 'Shipment Method';
        ...
        PaymentDiscountVATCaptionLbl: TextConst ENU = 'Payment Discount on VAT', ENA = 'Payment Discount on GST';
        ...
        GLAccountNoCaptionLbl: TextConst ENU = 'G/L Account No.', ENA = 'G/L Account No.';
        PrepaymentSpecCaptionLbl: TextConst ENU = 'Prepayment Specification', ENA = 'Prepayment Specification';
        PrepaymentVATAmtSpecCaptionLbl: TextConst ENU = 'Prepayment VAT Amount Specification', ENA = 'Prepayment GST Amount Specification';
        PrepmtPaymentTermsCaptionLbl: TextConst ENU = 'Prepmt. Payment Terms', ENA = 'Prepmt. Payment Terms';
        AmountCaptionLbl: TextConst ENU = 'Amount', ENA = 'Amount';
        InvDiscAmountCaptionLbl: TextConst ENU = 'Invoice Discount Amount', ENA = 'Invoice Discount Amount';
        ...
        AllowInvDiscountCaptionLbl: TextConst ENU = 'Allow Invoice Discount', ENA = 'Allow Invoice Discount';
