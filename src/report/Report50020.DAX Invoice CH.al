report 50020 "DAX Invoice CH"
{
    ...
    var
        ...
        Text002: TextConst ENU = 'Total %1 Incl. MwSt', ENA = 'Total %1 Incl. MwSt';
        Text003: TextConst ENU = 'COPY', ENA = 'COPY';
        Text004: TextConst ENU = 'Sales - Invoice %1', ENA = 'Sales - Invoice %1';
        PageCaptionCap: TextConst ENU = 'Seite %1 von %2', ENA = 'Seite %1 von %2';
        Text006: TextConst ENU = 'Total %1 Excl. MwSt', ENA = 'Total %1 Excl. MwSt';
        ...
        VATPercentCaptionLbl: TextConst ENU = 'MwSt %', ENA = 'MwSt %';
